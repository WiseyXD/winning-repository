...
export default function LandingPage() {
    ...
    return (
        <>
            ...
            <div className="min-h-[80vh] bg-zinc-950 overflow-hidden">
                <MacbookScroll
                    src="https://imgs.search.brave.com/bbgU3Lbc98AQiX97CyKEpwhiBbJiEzBWebM3L8TRcTI/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pLnN0/YWNrLmltZ3VyLmNv/bS8zcHk0ei5wbmc"
                    showGradient={false}
                    title="Aryan Created the Best UI"
                />
            </div>
